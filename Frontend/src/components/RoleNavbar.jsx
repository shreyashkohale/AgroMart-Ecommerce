...
const RoleNavbar = ({ isLoggedIn }) => {
    ...
    if (!isLoggedIn) {
        ...
        return (
            <ul className="navbar-nav ml-auto text-black">
                ...
                <li className="nav-item active">
                    <Link className="nav-link text-black" to="/getInfo">PRODUCT DETAILS</Link>
                </li>
                <li className="nav-item active">
        ...
        return (
            <ul className="navbar-nav ml-auto text-black">
                ...
                <NavDropdown title={<span className="text-black">ADD DETAILS</span>} id="basic-nav-dropdown" className="text-light" >
                        <NavDropdown.Item href="#action/3.1">
                         <Link className="nav-link text-black" to="/add-product">ADD PRODUCT</Link>
                        <Link className="nav-link text-black" to="/add-info">ADD PRODUCT DETAILS</Link>
                        <Link className="nav-link text-black" to="/addcategory">ADD CATEGORY</Link>
                ...
                <li className="nav-item active">
                    <Link className="nav-link text-black" to="/add-info">ADD INFO</Link>
                </li> */}
    ...
    return (
        <ul className="navbar-nav ml-auto ">
            ...
            <li className="nav-item active">
                <Link className="nav-link text-black" to="/getContactInfo">CONTACT</Link>
            </li>
            <li className="nav-item active">
                <Link className="nav-link text-black" onClick={logout} to="/">LOGOUT</Link>
            </li>
